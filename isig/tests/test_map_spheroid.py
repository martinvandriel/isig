...
def test_map_spheroid():
    ...
    px = np.array([0., 0.17558129, 0.34441509, 0., 0.18533581, 0.36354926, 0.,
                   0.19509032, 0.38268343, 0.34441509, 0.50001321, 0.6363961,
                   0.36354926, 0.52779172, 0.67175144, 0.38268343, 0.55557023,
                   0.70710678])
    py = np.array([0.9, 0.88270675, 0.83149158, 0.95, 0.93174602, 0.87768556,
                   1., 0.98078528, 0.92387953, 0.83149158, 0.74832265,
                   0.6363961, 0.87768556, 0.78989613, 0.67175144, 0.92387953,
                   0.83146961, 0.70710678])
